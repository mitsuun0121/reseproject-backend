...
class ShopsTableSeeder extends Seeder
{
    ...
    {
        // 地域を取得
        $area1 = Area::where('name', '東京都')->first();
        $area2 = Area::where('name', '大阪府')->first();
        $area3 = Area::where('name', '福岡県')->first();

        // ジャンルを取得
        $genre1 = Genre::where('name', '寿司')->first();
        $genre2 = Genre::where('name', '焼肉')->first();
        $genre3 = Genre::where('name', '居酒屋')->first();
        $genre4 = Genre::where('name', 'イタリアン')->first();
        $genre5 = Genre::where('name', 'ラーメン')->first();
